  ...
  $.fn.fstMmenu = function (options) {
    ...
    function updateCloneElement($cloneMenu) {
      $cloneMenu.find('ul, li').each(function (i, ele) {
        ...
        if ('LI' == ele.tagName && hasUl) $('>a', this).after(getArrowTemplate());
      });
    }
...
/***/ 0:
/*!*************************************************************!*\
  !*** multi ./src/js/fst-mmenu.js ./src/scss/fst-mmenu.scss ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./src/js/fst-mmenu.js */"./src/js/fst-mmenu.js");
module.exports = __webpack_require__(/*! ./src/scss/fst-mmenu.scss */"./src/scss/fst-mmenu.scss");


/***/ })

/******/ });
//# sourceMappingURL=fst-mmenu.js.map